...
public class BT {
	...
	private boolean CheckStructrallySameTree(Node node1, Node node2) {
		...
		if (node1 != null && node2 != null)
			return (CheckStructrallySameTree(node1.left, node2.left)
					&& CheckStructrallySameTree(node1.right, node2.right));
		else
			return false;
    ...
    public boolean structurally(BT o)
    {
    	return structurally(this.root,o.root);
    }
    
    private boolean structurally(Node root1, Node root2)
    {
    	if(root1==null && root2==null)
    	{
    		return true;
    	...
    	return structurally(root1.left,root2.left)&&structurally(root1.right,root2.right);
    }
